...
export default function Nav({initial = '', fullName = '', departmentName = ''}) {
	...
	return (
		<div className={`${style.container}`}>
			...
			<div className={style.left}>
				<div className={clsx(style.left1, "cursor-pointer")} onClick={() => router.push("/info/register")}>
				...
				<div className={style.left2}>
					<ul className={clsx(style.navMenu, "cursor-pointer")}>
						<li className={clsx(activeNav === '인사관리' ? style.active : "")}
								onClick={() => router.push("/info/register")}>인사관리
						</li>
						<li className={clsx(activeNav === '근태관리' ? style.active : "")}>근태관리</li>
						<li className={clsx(activeNav === '급여관리' ? style.active : "")}>급여관리</li>
						<li className={clsx(activeNav === '일용직관리' ? style.active : "")}>일용직관리</li>
					</ul>
				</div>
			</div>
